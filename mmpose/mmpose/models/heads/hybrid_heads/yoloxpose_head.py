...
class YOLOXPoseHead(BaseModule):
    ...
    def _get_targets(
        ...
        for i in range(num_imgs):
            # print(f"[YOLOXPoseHead_get_targets] batch_data_samples[{i}] shape: {batch_data_samples[i].gt_instances.keypoints.shape}")
    ...
    def _get_targets_single(
        ...
        # print(f"[YOLOXPoseHead_get_targets_single] gt_instances shape: {gt_instances.keypoints.shape}")
