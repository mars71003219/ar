...
class BottomupGetHeatmapMask(BaseTransform):
    ...
    def transform(self, results: Dict) -> Optional[dict]:
        ...
        # print(f"[BottomupGetHeatmapMask] transform output results: {results['keypoints'].shape}")
        return results
...
class BottomupRandomAffine(BaseTransform):
    ...
    def transform(self, results: Dict) -> Optional[dict]:
        ...
        # print(f"[BottomupRandomAffine] transform output results: {results['keypoints'].shape}")
        return results
