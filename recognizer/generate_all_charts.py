...
# 데이터 로드
with open('output/evaluation/summary_results.csv', 'r', encoding='utf-8') as f:
    lines = f.readlines()
...
# detailed 데이터 로드
detailed_data = []
with open('output/evaluation/detailed_results.csv', 'r', encoding='utf-8') as f:
    lines = f.readlines()
...
# metrics 로드
with open('output/evaluation/performance_metrics.json', 'r') as f:
    metrics = json.load(f)
